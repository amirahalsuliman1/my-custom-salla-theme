...
#### T-8.01 — Critical CSS and asset pipeline — ✅ **DONE 2026-08-11** · ⚠ **two criteria not met and not claimed: the 50 KB target, and inlining**
...
- **What was done:**
  ...
  - **⚠ «Above-fold CSS inlined» is not done either, and is on the manual checklist.** Deciding which rules are above the fold needs a rendered storefront and a browser; guessing means shipping a page that paints **wrong** rather than late, which is the worse failure. The «remainder deferred» half is done.
