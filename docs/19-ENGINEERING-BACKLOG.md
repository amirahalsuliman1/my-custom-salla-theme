...
#### T-4.08 — Home page assembly — 🟡 **PARTIAL 2026-08-08, third pass** — every section the backlog covers is now built; the artboard contains one section the backlog does not cover (OP-4), and three drawn elements belong to tasks still open
